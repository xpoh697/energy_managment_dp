...
print("DEBUG DETAILS AT SOC = 62%:")
print(f"  is_solar_surplus: {res.get('arbitrage_sell_debug', {}).get('debug_surplus', {}).get('is_surplus')}")
print(f"  hit_full_before: {res.get('sell_simulation', {}).get('hit_full_before')}")
print(f"  initial_budget: {res.get('arbitrage_sell_debug', {}).get('initial_budget')}")
print(f"  target_floors: {res.get('arbitrage_sell_debug', {}).get('target_floors')}")
print(f"  limit_reason: {res.get('arbitrage_sell_debug', {}).get('limit_reason')}")
print(f"  raw_commands: {res.get('raw_commands')}")
